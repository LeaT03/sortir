...
class SortieFixtures extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        $sortie1->setEtat($this->getReference('etat '.mt_rand(1,6)));
        ...
        $sortie2->setEtat($this->getReference('etat '.mt_rand(1,6)));
        ...
        $sortie3->setInfosSortie('Une partie de painball en pleine forêt');
        $sortie3->setCampusOrganisateur($this->getReference('campus '.mt_rand(1,4)));
        $sortie3->setEtat($this->getReference('etat '.mt_rand(1,6)));
        ...
        $sortie4->setEtat($this->getReference('etat '.mt_rand(1,6)));
