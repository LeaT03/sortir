...
class Participant implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     */
    #[ORM\ManyToMany(targetEntity: Sortie::class, inversedBy: 'participantInscrits')]
    private Collection $sorties;

    #[ORM\ManyToOne(inversedBy: 'participantRattaches')]
    ...
    public function addSortieOrganisee(Sortie $sortieOrganisee): static
    {
        if (!$this->sortieOrganisees->contains($sortieOrganisee)) {
            ...
            $sortieOrganisee->setParticipantOrganisateur($this);
        }
    ...
    public function removeSortieOrganisee(Sortie $sortieOrganisee): static
    {
        if ($this->sortieOrganisees->removeElement($sortieOrganisee)) {
            ...
            if ($sortieOrganisee->getParticipantOrganisateur() === $this) {
                $sortieOrganisee->setParticipantOrganisateur(null);
            }
        }
