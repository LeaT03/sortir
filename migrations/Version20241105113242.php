 ...
 */
final class Version20241105113242 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE participant (id INT AUTO_INCREMENT NOT NULL, campus_id INT NOT NULL, pseudo VARCHAR(50) NOT NULL, nom VARCHAR(50) NOT NULL, prenom VARCHAR(50) NOT NULL, telephone VARCHAR(15) DEFAULT NULL, email VARCHAR(180) NOT NULL, password VARCHAR(255) NOT NULL, actif TINYINT(1) DEFAULT NULL, roles JSON NOT NULL, INDEX IDX_D79F6B11AF5D55E1 (campus_id), UNIQUE INDEX UNIQ_IDENTIFIER_PSEUDO (pseudo), UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE sortie (id INT AUTO_INCREMENT NOT NULL, campus_organisateur_id INT NOT NULL, participant_organisateur_id INT NOT NULL, lieu_id INT NOT NULL, etat_id INT NOT NULL, nom VARCHAR(50) DEFAULT NULL, date_heure_debut DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', duree INT DEFAULT NULL, date_limite_inscription DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', nb_inscription_max INT DEFAULT NULL, infos_sortie VARCHAR(300) DEFAULT NULL, INDEX IDX_3C3FD3F29C026F8E (campus_organisateur_id), INDEX IDX_3C3FD3F217AE6A42 (participant_organisateur_id), INDEX IDX_3C3FD3F26AB213CC (lieu_id), INDEX IDX_3C3FD3F2D5E86FF (etat_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
